...
let iconClick= ()=>{
    let promise= new Promise(
    (resolve,reject)=>{
        if(document.getElementById("icon").value=="notify"){
            resolve("On");
        }else{
            reject("Off");
        }
    ...
    promise.then((message)=>{
        ...
        document.getElementById("icon").value="Unnotify";//setting value

        document.getElementById("icon").src="on.png";//adding on.png
        document.getElementById("icon").classList.remove("notify-off");//removing class
        ...
        console.log("Notification is "+message);
        document.getElementById("icon").value="notify";//setting value

        document.getElementById("icon").src="off.png";//adding off png
        document.getElementById("icon").classList.remove("notify-on");
    })
